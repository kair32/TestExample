...
public class LoginActivity extends AppCompatActivity {
    ...
    private EditText vEditTextPassword, vEditTextUserName;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vEditTextUserName = (EditText)findViewById(R.id.editText_login);
        vEditTextPassword = (EditText)findViewById(R.id.editText_password);

        vEntrButton = (Button)findViewById(R.id.button_entr);
        vEntrButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(vEditTextUserName.getText().toString()!="" && vEditTextPassword.getText().toString()!=""){
                    zaprosone();
                }
            }
        });
    ...
    public void zaprosone(){
        ...
        try {
            jsonParams.put("login", vEditTextUserName.getText().toString());
        ...
        client.post(this, "https://api.smiber.com/v4.005/salt",entity,null, new JsonHttpResponseHandler(){
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                try {
                    JSONArray jsonObjectError = errorResponse.getJSONArray("errors");
                    JSONObject jsonObject = (JSONObject) jsonObjectError.get(0);
                    String str = jsonObject.getString("message");
                    Toast.makeText(LoginActivity.this,"Ошибка " + jsonObject.getString("message"),Toast.LENGTH_LONG).show();
    ...
    public void zaprostwo() throws Exception {
        RequestBody formBody = new FormBody.Builder()
                ...
                .add("username", vEditTextUserName.getText().toString())
                .add("password", convert(convert(vEditTextPassword.getText().toString()) + salt))
                .build();
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try{
                    ...
                    if (jsonObject.getString("code").equals("401")) {
                        Toast.makeText(LoginActivity.this, "Ошибка, неверный пароль!", Toast.LENGTH_LONG).show();
                    }
                }catch (JSONException e){}
                try{
                    JSONObject jsonObject = new JSONObject(res);
